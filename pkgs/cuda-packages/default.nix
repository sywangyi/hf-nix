...
let
  ...
  passthruFunction = final: {
    ...
    cudatoolkit = final.callPackage ./cudatoolkit/redist-wrapper.nix { };
      ...
      let
        ...
        builder =
          ...
          }@config:
          {
            ...
            value = final.callPackage ./tests/opencv-and-torch config;
          };
      in
      attrsets.listToAttrs (attrsets.mapCartesianProduct builder configs)
      // {
        flags = final.callPackage ./tests/flags.nix { };
      };
  };
  ...
  composedExtension = fixedPoints.composeManyExtensions (
    [
      ...
      (import ./cuda/extension.nix { inherit cudaMajorMinorVersion lib; })
      (import ./generic-builders/multiplex.nix {
        ...
        pname = "cudnn";
        redistName = "cudnn";
        releasesModule = ./cudnn/releases.nix;
        shimsFn = ./cudnn/shims.nix;
      })
      (import ./cutensor/extension.nix {
        inherit
          cudaLib
          cudaMajorMinorVersion
          lib
      ...
      (import ./cusparselt/extension.nix {
        inherit
          cudaLib
          lib
          redistSystem
      ...
      (import ./generic-builders/multiplex.nix {
        ...
        pname = "tensorrt";
        redistName = "tensorrt";
        releasesModule = ./tensorrt/releases.nix;
        shimsFn = ./tensorrt/shims.nix;
      })
      (import ./cuda-samples/extension.nix {
